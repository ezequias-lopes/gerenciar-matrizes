    ...
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
      ...
      <div className="p-6 border-b border-slate-150 bg-slate-50/50 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h2 className="text-base font-bold text-slate-950">Folha de Atribuições</h2>
            <p className="text-xs text-slate-500">Mapeamento estruturado em ordem alfabética</p>
          </div>
        </div>
      ...
      {/* Rodapé informativo */}
      <div className="bg-slate-50 px-6 py-3  border-t border-slate-150 flex justify-center items-center gap-2 text-xs text-slate-500 font-medium">
        <span>
